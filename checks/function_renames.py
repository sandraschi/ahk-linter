...
FUNCTION_RENAMES = {
    ...
    "ComObjFlags": "ComValue",
    "ComObjActive": "ComObject",
    "Exception": "Error",
    "RegisterCallback": "CallbackCreate",
    "LV_Add": "ListView.Add",
    "LV_Delete": "ListView.Delete",
    "LV_GetCount": "ListView.GetCount",
    "LV_GetNext": "ListView.GetNext",
    "LV_GetText": "ListView.GetText",
    "LV_Modify": "ListView.Modify",
    "LV_ModifyCol": "ListView.ModifyCol",
    "LV_Insert": "ListView.Insert",
    "LV_DeleteCol": "ListView.DeleteCol",
    "LV_InsertCol": "ListView.InsertCol",
    "LV_SetImageList": "ListView.SetImageList",
    "TV_Add": "TreeView.Add",
    "TV_Delete": "TreeView.Delete",
    "TV_GetChild": "TreeView.GetChild",
    "TV_GetCount": "TreeView.GetCount",
    "TV_GetNext": "TreeView.GetNext",
    "TV_GetParent": "TreeView.GetParent",
    "TV_GetPrev": "TreeView.GetPrev",
    "TV_GetSelection": "TreeView.GetSelection",
    "TV_GetText": "TreeView.GetText",
    "TV_Modify": "TreeView.Modify",
    "TV_SetImageList": "TreeView.SetImageList",
    "SB_SetIcon": "StatusBar.SetIcon",
    "SB_SetParts": "StatusBar.SetParts",
...
class OldObjectModelCheck(BaseCheck):
    ...
    def run(self, source: str, ast: Tree | None) -> list[dict]:
        ...
        for m in re.finditer(r"\.HasKey\(", source):
            ...
            issues.append(
                self._make_issue(
                    "V1_HASKEY", "Use obj.Has(key) instead of obj.HasKey(key)", line, fixable=False
                )
            )
