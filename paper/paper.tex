...
\bibitem{semgrep}
\url{https://semgrep.dev}. Semgrep: multi-language pattern matching. Accessed 2026.
\bibitem{treesitter}
\url{https://tree-sitter.github.io/tree-sitter/}. Tree-sitter parser library. Accessed 2026.
\bibitem{astgrep}
\url{https://ast-grep.github.io/}. AST-grep: structural code search and linting. Accessed 2026.
\end{thebibliography}
